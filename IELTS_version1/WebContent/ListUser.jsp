...
=======
							<li class ="active"><a href="#paper51" style='color: white'>User</a></li>
			...
			<div class="panel panel-default">
	         ...
	         DBUtils dbs=new DBUtils();	                   
									if (request.getAttribute("piList") == null) {
										for (TaiKhoaNguoiDung1 thr :dbs.queryProduct(conn)) {
								%>
							<tr>
								...
								<td>
								<div class= "row">
								<a href="Xoa?user_id=<%=thr.getUser_id()%>"><button
											type="button" class="btn btn-default "
											onclick="return confirmAction()">
											<span class="glyphicon glyphicon-trash"></span>
										</button></a>
										<a href="CapNhatActive?userName=<%=thr.getUserName()%>"><button type="button" class="btn btn-default btn-sm">
...
=======
		...
		<div class="panel panel-default">
  			<div class="panel-body">
  				<div class="col-md-6">
    				<button type="button" class="btn btn-primary"><a href ="Register.jsp"></a> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Register Pasien Baru </button>
  				</div><!-- /.col-lg-6 -->
  				<div class="col-md-6">
    				<div class="input-group">
