...
@WebServlet(urlPatterns = { "/userTimetable" })
public class UserTimetableServlet extends HttpServlet {
	  private static final long serialVersionUID = 1L;
	 
	  public UserTimetableServlet() {
	      super();
	  }
	  @Override
	  protected void doGet(HttpServletRequest request, HttpServletResponse response)
	      ...
	      RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/IndexCalendar.jsp");
