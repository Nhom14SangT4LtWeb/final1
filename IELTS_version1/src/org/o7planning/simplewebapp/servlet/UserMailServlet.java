...
@WebServlet(urlPatterns = { "/userMail" })
public class UserMailServlet extends HttpServlet {
	  private static final long serialVersionUID = 1L;
	 
	  public UserMailServlet() {
	      super();
	  }
	  @Override
	  protected void doGet(HttpServletRequest request, HttpServletResponse response)
	      ...
	      RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/MyBox.jsp");
